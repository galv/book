...
(function() {
  ...
  controller.on('frame', function(frame) {
    ...
    /*
    debugger = document.getElementById("positions");
    knowledge = "";
    
    for (index = 0; index < hand.fingers.length; index++) {
	position = hand.fingers[i].stabilizedTipPosition;
	knowledge +=  index +": x: " + position[0] + " y: " + position[1] +
	    " z: " + positions[2];
    }
    debugger.innerHTML = knowledge
    */
    ...
    //return;
    return extraOutput.innerHTML = hand.fingers[0].stabilizedTipPosition.toArray().map(function(num) {
